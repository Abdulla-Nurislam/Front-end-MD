...
export default function NotificationsScreen() {
  ...
  const renderNotification = ({ item }: { item: Notification }) => {
    ...
    return (
      <TouchableOpacity style={[styles.notificationItem, !item.read && styles.unreadItem]} onPress={() => markAsRead(item.id)} activeOpacity={0.7}>
        ...
        <View style={styles.notificationContent}>
          <Text style={styles.notificationText}><Text style={styles.userName}>{item.user.name}</Text>{' '}{item.message}</Text>
