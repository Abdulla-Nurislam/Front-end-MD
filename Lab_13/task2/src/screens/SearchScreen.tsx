  ...
  const renderResult = ({ item }: { item: SearchResult }) => (
    <TouchableOpacity style={styles.resultItem}>
      <View style={styles.resultIcon}>
        <Ionicons name={item.type === 'user' ? 'person' : item.type === 'hashtag' ? 'pricetag' : 'document-text'} size={24} color="#666" />
      </View>
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.searchContainer}>
        <View style={styles.searchInputContainer}>
          ...
          <TextInput style={styles.searchInput} placeholder="Search users, posts, hashtags..." placeholderTextColor="#999" value={searchQuery} onChangeText={handleSearch} autoCapitalize="none" autoCorrect={false} />
